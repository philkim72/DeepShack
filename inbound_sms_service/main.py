...
def lambda_handler(event, context):
    ...
    # - if text_content contains a keyword suggesting the user wants to scrape,
    ...
    return '<?xml version=\"1.0\" encoding=\"UTF-8\"?>'\
           '<Response><Message>Hello from DeepShack! We are calculating your \
            time-to-burger. Hang tight...</Message></Response>'
